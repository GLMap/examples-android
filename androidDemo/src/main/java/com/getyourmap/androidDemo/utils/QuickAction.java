...
import com.getyourmap.androidDemo.R;
...
public class QuickAction {
    ...
    public void addActionItem(ActionItem action) {
        ...
        if (track.getChildCount() != 0) {
            ...
            separator.setLayoutParams(new RelativeLayout.LayoutParams(2, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public void show(View parent, float screenX, float screenY) {
        ...
        if (rootWidth > screenWidth - arrowWidth) {
            ...
            rootView.measure(View.MeasureSpec.makeMeasureSpec(rootWidth, View.MeasureSpec.EXACTLY), ViewGroup.LayoutParams.WRAP_CONTENT);
        }
