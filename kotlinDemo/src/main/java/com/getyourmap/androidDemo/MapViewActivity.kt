...
import com.getyourmap.glmap.*
import com.getyourmap.glmap.GLMapManager.StateListener
import com.getyourmap.glmap.GLMapManager.TileDownloadProgress
import com.getyourmap.glmap.GLMapTrackData.PointsCallback
...
open class MapViewActivity : Activity(), ScreenCaptureCallback, StateListener {
        ...
        if (btnDownloadMap.visibility == View.VISIBLE) {
            ...
            if (mapToDownload != null) {
                ...
                text = if (total != 0L) {
                    ...
                    String.format(Locale.getDefault(), "Downloading %s %d%%",
                            mapToDownload.getLocalizedName(localeSettings), progress)
                } else {
                    String.format(Locale.getDefault(), "Download %s",
    ...
    private fun bulkDownload() {
        ...
        actionButton.setOnClickListener {
            ...
            GLMapManager.CacheTiles(allTiles,
    ...
    private fun recordTrack() {
        ...
        trackPointIndex = 100
        val trackData = GLMapTrackData(PointsCallback { index, nativePoint ->
    ...
    companion object {
        private val unionColours = intArrayOf(Color.argb(255, 33, 0, 255),
